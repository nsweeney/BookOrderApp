...
public class NewInstructorDialog extends JDialog {
	...
	public static void main(String[] args) {
		try {
			NewInstructorDialog dialog = new NewInstructorDialog();
	 ...
	 * Create the dialog.
	 */
	public NewInstructorDialog() {
		setTitle("Submit New Instructor");
